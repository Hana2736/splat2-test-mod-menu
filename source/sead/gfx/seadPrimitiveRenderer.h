...
public:
    ...
    virtual void beginImpl(DrawContext *, Matrix34f const&,sead::Matrix44f const&) = 0;
    ...
    virtual void drawWireCubeImpl(const Matrix34f& model_mtx, const Color4f& c0,
                                  const Color4f& c1) = 0;
    virtual void drawLineImpl(sead::DrawContext *, const Matrix34f& model_mtx, const Color4f& c0, const Color4f& c1) = 0;
